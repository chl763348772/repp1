...
public class CartController extends BaseController {
	...
	public ResponseResult<Void> addNum(HttpSession session,@PathVariable ("id") Integer cid){
		Integer uid=getUidFromSession(session);
		String username=session.getAttribute("username").toString();
	...
	public ResponseResult<List<CartVO>> getByCids(Integer[] cid){
		
		//执行
		List<CartVO> data=cartService.getByCids(cid);
		//返回
		return new ResponseResult<>(SUCCESS,data);
	}
}
